...
public class RSASignature {
    ...
    public static boolean doCheck(String content,String sign,String publicKey,String encode){
        try{
            ...
            byte[] encodeKey = decoder.decodeBuffer(publicKey);

           // byte[] encodeKey =RSAUtils.decryptBASE64(publicKey);
            ...
            //PublicKey pubKey = keyFactory.generatePublic(new PKCS8EncodedKeySpec(encodeKey));
            Signature signature = Signature.getInstance(SIGN_ALGORITHMS);
